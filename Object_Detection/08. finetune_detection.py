...
download(url, path='img/pikachu_train.rec', overwrite=False)
download(idx_url, path='img/pikachu_train.idx', overwrite=False)

#############################################################################################
# We can load dataset using ``RecordFileDetection``
dataset = gcv.data.RecordFileDetection('img/pikachu_train.rec')
...
net.save_parameters('parameters/ssd_512_mobilenet1.0_pikachu.params')
...
download(test_url, 'img/pikachu_test.jpg')
net = gcv.model_zoo.get_model('ssd_512_mobilenet1.0_custom', classes=classes, pretrained_base=False)
net.load_parameters('parameters/ssd_512_mobilenet1.0_pikachu.params')
